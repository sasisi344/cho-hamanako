...
summary: "はまゆう大橋の釣りポイント紹介。遠浅の砂地が続く地帯で、キビレやクロダイのシャローポイント。陸釣りは「知る人ぞ知る」穴場で、秋の夜長にまったりキビレを狙うのが最適。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "中浜名湖", "はまゆう大橋", "浜松市", "古人見"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  difficulty: "Beginner"
  familyFriendly: true
  bestSeason: ["春", "夏", "秋"]
  methods: ["ルアー", "投げ釣り", "ウキ釣り"]
  targetFish: ["キビレ", "シーバス", "クロダイ", "ハゼ", "コウイカ", "ギマ", "サヨリ"]
facilities:
  parking: true
  toilet: true
  convenienceStore: "ローソン浜松雄踏山崎店"
  nightFishing: true
location:
  name: "はまゆう大橋"
...
[沖縄cafe 果報](http://okinawacafe-kafu.com)
