...
summary: "村櫛海水浴場の釣りポイント紹介。浅くて広いエリアで、夏はトップゲーム、秋は投げ釣りで多彩な魚種が狙える。無料駐車場とトイレ完備でファミリーにもおすすめ。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "中浜名湖", "村櫛", "ファミリーフィッシング"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  difficulty: "Beginner"
  familyFriendly: true
  bestSeason: ["春", "夏", "秋", "冬"]
  methods: ["投げ釣り", "ルアー", "フライ"]
  targetFish: ["キビレ", "シーバス", "カレイ", "キス", "カワハギ"]
facilities:
  parking: true
  toilet: true
...
*   **無料駐車場とトイレ完備**でファミリーにも優しい！
*   **航路沿いの深場と広大な浅場の両方**を楽しめる地形！
