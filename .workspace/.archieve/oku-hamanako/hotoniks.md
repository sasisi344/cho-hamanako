...
summary: "浜松ホトニクス産業開発研究所の東にある「マイマイ」と呼ばれる釣りポイント紹介。急深な地形を利用した底物狙いが特徴で、キビレやシーバスの実績が高い。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "奥浜名湖", "浜松ホトニクス", "マイマイ", "キビレ"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  ...
  bestSeason: ["春", "夏", "秋"]
  methods: ["投げ釣り", "ブッコミ", "ルアー"]
  targetFish: ["キビレ", "シーバス", "クロダイ", "ハゼ"]
facilities:
  parking: true
  toilet: false
  convenienceStore: "セブンイレブン細江町気賀店"
  nightFishing: true
location:
  name: "ホトニクス下（マイマイ）"
...
*   **対象魚**：キビレ
*   **おすすめエサ**：青ジャムシ、ユムシ
*   **おすすめタックル**：オモリ負荷10～20号の投げ竿でブッコミ仕掛け
...
*   **対象魚**：キビレ、シーバス
*   **おすすめルアー**：シンキングペンシル、ペンシルベイト、レンジバイブ
...
[浜名湖オルゴールミュージアム](https://www.hamanako-orgel.jp)
