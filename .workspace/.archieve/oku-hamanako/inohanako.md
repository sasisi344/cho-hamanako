...
summary: "奥浜名湖エリアの「猪鼻湖」の釣りポイント紹介。エリアによって特徴が異なり、ボート釣りが有利だが、場所によっては岸からの投げ釣りやウェーディングも楽しめる。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "奥浜名湖", "猪鼻湖", "三ヶ日", "ボートフィッシング"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  ...
  familyFriendly: true
  bestSeason: ["春", "夏", "秋", "冬"]
  methods: ["投げ釣り", "ルアー", "ボート釣り"]
  targetFish: ["キビレ", "シーバス", "カレイ", "ハゼ", "クロダイ"]
facilities:
  parking: true
  toilet: true
