...
summary: "観光地である舘山寺（内浦湾）の釣りポイント紹介。初心者にも優しい足場の良いポイントで、エサ釣りとルアー釣りの両方が楽しめる。夏から秋のキビレ・シーバス実績が高い。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "奥浜名湖", "舘山寺", "内浦湾", "キビレ"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  difficulty: "Beginner"
  familyFriendly: true
  bestSeason: ["春", "夏", "秋"]
  methods: ["エサ釣り", "投げ釣り", "ルアー"]
  targetFish: ["キビレ", "シーバス", "クロダイ", "ハゼ", "サヨリ"]
facilities:
  parking: true
  toilet: true
  convenienceStore: "セブンイレブン浜松舘山寺町店"
  nightFishing: true
location:
  name: "内浦（うちうら）"
  address: "静岡県浜松市中央区舘山寺"
  lat: 34.766068
  lng: 137.620257
...
1.  パルパル～動物園：ほぼ水深が一定で初心者にもやりやすい
2.  舘山寺山～ロープウェイ下：水深変化があるのでタナの理解度が必要
3.  大草山側：投げ釣り向け
