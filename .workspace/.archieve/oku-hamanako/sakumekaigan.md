...
summary: "奥浜名湖エリアの「佐久米海岸」の解説。遠浅の砂利浜と護岸エリアがあり、ウェーディングがおすすめ。夏から秋のキビレ・シーバス、冬のランカーシーバスが狙い目。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "奥浜名湖", "佐久米", "キビレ", "シーバス", "ウェーディング"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  difficulty: "Beginner"
  familyFriendly: true
  bestSeason: ["春", "夏", "秋", "冬"]
  methods: ["投げ釣り", "ウキ釣り", "ルアー", "ウェーディング"]
  targetFish: ["キビレ", "シーバス", "クロダイ", "ハゼ", "サヨリ", "ギマ"]
facilities:
  parking: true
  toilet: true
  convenienceStore: "ファミリーマート浜名湖SA店"
  nightFishing: true
location:
  name: "佐久米海岸（さくめかいがん）"
...
*   **対象魚**：五目釣り
*   **おすすめエサ**：青ジャムシ
*   **おすすめタックル**：オモリ負荷10号程度の投げ竿で三本針仕掛け
...
*   **対象魚**：シーバス
*   **おすすめルアー**：シンペン、7～12cmのミノーをレンジで使い分け
...
使うタックルは90cmクラスを視野にしたスペックにするべき。でも普遍的なシーバスモデル（ML：20gは対応）なら、ドラグ出しながら耐えれます。もしパワーでなんとかしたいなら、耐久としなやかさをあわせもつハイエンドモデルがおすすめになります。
...
[Tabist Magazine - ゆるキャン△聖地巡礼](https://magazine.tabist.co.jp/area/chubu/3246/)
