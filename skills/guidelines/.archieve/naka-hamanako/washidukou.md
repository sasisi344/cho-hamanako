...
summary: "鷲津湾（鷲津港）周辺の釣りポイント紹介。ボート釣りがメインのエリアで、バスフィッシング感覚でキビレやシーバスを狙うテクニカルな釣りが楽しめる。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "中浜名湖", "鷲津", "湖西市", "ボートフィッシング"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  difficulty: "Advanced"
...
facilities:
  parking: false
  toilet: false
  convenienceStore: "ファミリーマート鷲津駅前店"
  nightFishing: true
location:
  name: "鷲津湾"
  address: "静岡県湖西市鷲津"
