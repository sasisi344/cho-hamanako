...
summary: "庄内湖はボートルアーがおすすめのエリア。牡蠣棚などのストラクチャーについたシーバスを狙うテクニカルなポイント。"
pubDate: 2024-08-01
category: "points"
tags: ["浜名湖", "釣り場", "奥浜名湖", "庄内湖", "シーバス", "ボートフィッシング"]
draft: true
cover: "./cover.jpg"
fishinginfo:
  ...
  bestSeason: ["春", "夏", "秋"]
  methods: ["ボート", "ルアー", "投げ釣り", "ぶっこみ"]
  targetFish: ["シーバス", "キビレ", "クロダイ", "ハゼ"]
facilities:
  parking: false
  toilet: false
  convenienceStore: "セブンイレブン浜松佐浜町店"
  nightFishing: true
location:
  name: "庄内湖（しょうないこ）"
...
*   **対象魚**：シーバス
*   **おすすめルアー**：トップからボトムまで満遍なく探れるラインナップで
...
[ぬくもりの森 公式サイト](https://www.nukumori.jp/)
